...
{
    [BMessage("Info", "The Object does not have a Mesh Renderer!", 5, 5)]
    public bool messageNoRenderer = false;

    [BMessage("Info", "Objects using multiple materials are not supported!", 5, 5)]
    public bool messageMultiMaterials = false;

    [BMessage("Info", "The Object does not have a Material assigned!", 5, 5)]
    public bool messageNoMaterial = false;

    [BMessage("Info", "Please note that the Height Fog Per Object option is EXPERIMENTAL and will not work for all transparent objects. Available in Play mode only. Please read the documentation for more!", 5, 5)]
    ...
    [BMessage("Info", "The is not a valid Height Fog material! Please assign the correct shader first!", 5, 0)]
