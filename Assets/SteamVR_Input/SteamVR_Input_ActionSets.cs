...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_VR_project p_VR_project;
        ...
        public static SteamVR_Input_ActionSet_VR_project VR_project
        {
            get
            {
                return SteamVR_Actions.p_VR_project.GetCopy<SteamVR_Input_ActionSet_VR_project>();
            }
        }
        ...
        private static void StartPreInitActionSets()
        {
            ...
            SteamVR_Actions.p_VR_project = ((SteamVR_Input_ActionSet_VR_project)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_VR_project>("/actions/VR_project")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions._default,
                    SteamVR_Actions.platformer,
                    SteamVR_Actions.buggy,
                    SteamVR_Actions.mixedreality,
                    SteamVR_Actions.VR_project};
        }
    }
}
